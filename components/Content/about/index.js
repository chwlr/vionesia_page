...
import { CgAlbum, CgLayoutGridSmall } from 'react-icons/cg'
      ...
      <Container className="my-5">
        <Row>
          <Col className="text-center">
            <h3 style={{ margin: '2em 0 2em 0' }}>An enterprise consulting organization, <br></br> technology enabler and system integrator</h3>
            {/* <p>an enterprise consulting organization, <br></br> technology enabler and system integrator</p> */}
          </Col>
        </Row>
